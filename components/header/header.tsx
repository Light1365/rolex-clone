...
const Header = () => {
  return (
    <div className="h-dvh">
      <div className="header w-full h-28 text-white p-10 flex flex-row justify-center items-center">
        <button className="ml-16">Menu</button>
        <div className="h-full w-full flex flex-column justify-center items center pl-80">
          <svg
        ...
        <div className="flex flex-row gap-32 items-center text-sm">
          ...
          <a className="flex flex-row pr-10">
